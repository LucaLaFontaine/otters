...
# Addendum: Edited by Luca LaFontaine 2023 and incorporated into the LuTools project. 
# Addendum: If anyone knows how to properly communicate that this code does not belong to Luca but he edited it please submit a pull request
